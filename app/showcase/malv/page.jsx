    ...
    <main className="flex min-h-screen flex-col items-center justify-start lg:p-24">
      ...
      <div className="">
        <div className="w-screen px-5 lg:px-0 lg:w-[640px] mt-32">
          <h1 className="text-6xl mb-12 font-semibold">MyAnimeList Viewer</h1>
          {/* <h1 className="text-3xl mb-6 font-semibold">Passion and Purpose</h1> */}

          <div className="rounded-lg flex-col bg-black h-72 flex items-center justify-center pt-8 overflow-hidden">
            <Image
          ...
          <div className="flex flex-col">
            ...
            <Link
              href="/showcase"
              className="card-hover mt-4 mb-32 p-4 px-8 rounded-lg bg-indigo-500 border border-indigo-100 text-black hover:text-white font-bold text-lg cursor-pointer"
            >
