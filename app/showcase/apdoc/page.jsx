        ...
        <div className="">
          <div className="w-screen px-5 lg:px-0 lg:w-[640px] mt-32">
            ...
            <p className="paragraph text-gray-500 mt-2">
              ...
              operations, Role-based admin access ensures that your digital
              assets and sensitive information are safeguarded while enabling
              efficient collaboration and task delegation.
            </p>
            ...
            <p className="paragraph text-gray-500 mt-2">
              The Receipt Customization feature is a versatile tool that
              empowers businesses to create, personalize, and fine-tune their
              receipts.
            </p>
            <p className="paragraph text-gray-500 mt-2">
              feature provides the flexibility to design and customize receipts
              to meet your unique branding, compliance, and record-keeping
              needs.
            </p>
            ...
            <p className="paragraph text-gray-500 mt-8">
              ...
              implemented critical components, including data management,
              patient queue management, purchase order management, and inventory
